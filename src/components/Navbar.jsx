...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div
        className='w-full flex justify-between items-center max-w-7xl max-auto'
      >
        <Link
          to="/"
        ...
        <ul className='list-none hidden sm:flex flex-row gap-10'>
          {navLinks.map((link)=>(
            ...
            >
              ...
              <a href={link.id === 'github'?  "https://github.com/kundansingh333" : link.id=="linkedin"?"https://www.linkedin.com/in/kundankumar333/":`#${link.id}`}>{link.title}</a>
            </li>
          ))}
        </ul>
        <div
